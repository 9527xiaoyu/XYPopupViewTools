...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of XYPopupViewTools.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { '9527xiaoyu' => '1446899815@qq.com' }
  s.source           = { :git => 'https://github.com/9527xiaoyu/XYPopupViewTools.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'XYPopupViewTools/Classes/**/*'
  
  # s.resource_bundles = {
  #   'XYPopupViewTools' => ['XYPopupViewTools/Assets/*.png']
  # }
